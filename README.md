...
## 🎵 Background music
Put an MP3 at: `music/love.mp3`

> Note: browsers usually block autoplay — the music starts when the button is clicked.
...
5. Your site link will appear on the same page
