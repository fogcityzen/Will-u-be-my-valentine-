...
button.addEventListener("click", () => {
  // Browsers typically block autoplay without interaction.
...
if (button.textContent === "if your answer is Yes, call me on my phone when u can 🫶❤️") {
    ...
    fetch('send_mail.php')
      .then(response => {
        if (response.ok) {
          button.textContent = "i love you forever and i love you always";
        } else {
...
function drawText() {
    ...
    // glow effect
    context.shadowColor = "rgba(220, 20, 60, 1)";
    ...
    if(frameNumber < 250){
        ...
        context.fillText("every day I still can't believe you're mine", canvas.width/2, canvas.height/2);
    ...
    if(frameNumber > 500 && frameNumber < 750){
        ...
        if (window.innerWidth < 600) {           //shortens long sentence for mobile screens
            ...
            context.fillText("among countless stars, across endless time", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber > 1000 && frameNumber < 1250){
        context.fillStyle = `rgba(220, 20, 60, ${opacity})`;
        context.fillText("to breathe, and to share this life with you", canvas.width/2, canvas.height/2);
        opacity = opacity + 0.01;
    }
    ...
    if(frameNumber > 1500 && frameNumber < 1750){
        context.fillStyle = `rgba(220, 20, 60, ${opacity})`;
        context.fillText("is so rare it feels like destiny", canvas.width/2, canvas.height/2);
        opacity = opacity + 0.01;
    }
    ...
    if(frameNumber > 2000 && frameNumber < 2250){
        ...
        if (window.innerWidth < 600) {
            ...
            context.fillText("and yet here I am, living the miracle of loving you", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber >= 2750 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            ...
            context.fillText("and I can't wait to spend forever proving it, softly, every day.", canvas.width/2, (canvas.height/2 + 50));
        }
...
function draw() {
    if (!started) { window.requestAnimationFrame(draw); return; }
